# ruff: noqa: I001
"""
Binary Classification with ASKF
===============================

Calculates two kernels, and trains a BinaryASKFClassifier on them.
Shows GridSearchCV compatability.
"""
...
clf = GridSearchCV(BinaryASKFClassifier(variation="minmax"), parameters).fit(
    K_train, y_train
)
