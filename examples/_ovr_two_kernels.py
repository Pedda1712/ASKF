# ruff: noqa: I001
"""
Multi-Classification using One-Vs-Rest Wrapping
===============================================

Computes two kernels on a 4-class dataset.
Shows OneVsRestClassifier compatability.
"""
...
clf = GridSearchCV(
    OneVsRestClassifier(BinaryASKFClassifier(variation="minmax")), parameters
).fit(K_train, y_train)
