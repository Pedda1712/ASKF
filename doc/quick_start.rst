...
To create your package, you need to clone the ``ASKF`` repository:

.. prompt:: bash $

  git clone https://github.com/scikit-learn-contrib/ASKF.git

Before to reinitialize your git repository, you need to make the following
changes. Replace all occurrences of ``ASKF``, ``ASKF``, or
``ASKF`` with the name of you own project. You can find all the
