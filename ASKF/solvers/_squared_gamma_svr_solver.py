# ruff: noqa: I001
"""
Sample code automatically generated on 2024-11-09 18:32:17
...
variables
  ...
  vector eigenvalues
min
  0.5*(a1-a2)'*eigenvectors*diag(eigenvalues)*eigenvectors'*(a1-a2)-y'*(a1-a2)+epsilon*sum(a1+a2)+beta*sum(eigenvalues)+gamma*(eigenvaluesOld-eigenvalues)'*F*(eigenvaluesOld-eigenvalues)
st
  sum(a1) == sum(a2)
  0 <= a1
  0 <= a2
